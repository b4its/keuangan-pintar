...
<head>
    ...
    <title>Login / Register - Keuangan Pintar</title>
...
<body class="min-h-screen relative overflow-hidden">
    ...
    <div class="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2 relative z-10 px-6 lg:px-20">
        ...
        <div class="hidden lg:flex flex-col h-full justify-start pt-[20vh]">
            <p class="text-[#003344] font-semibold text-lg mb-2">Keuangan Pintar</p>
        ...
        <div class="flex items-center justify-center lg:justify-end w-full h-full pb-10 lg:pb-0">
            ...
            <div
                class="bg-white rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] w-full max-w-[480px] p-8 md:p-12 border-[3px] border-[#023A4B] backdrop-blur-sm relative transition-all duration-300">
                ...
                <div id="login-container" class="fade-in">
                    <div class="text-center mb-8">
                        <h2 class="text-3xl font-[800] text-[#003344]">Log in</h2>
                    ...
                    <form action="{{ route('auth') }}" method="POST" class="space-y-5">
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute inset-y-0 right-0 pr-5 flex items-center cursor-pointer"
                                ...
                                <svg id="eye-icon-login" class="h-5 w-5 text-gray-400 hover:text-gray-600" fill="none"
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-gray-500 font-medium text-sm">
                            Belum punya akun?
                            <button onclick="switchLayout('register')"
                                class="text-[#209E43] font-bold hover:underline hover:text-[#1a7f36]">
                                Sign up
                            </button>
                        </p>
                    </div>
                ...
                <div id="register-container" class="hidden fade-in">
                    ...
                    <form action="{{ route('auth') }}" method="POST" class="space-y-4">
                        ...
                        <div class="relative group">
                            ...
                            <input type="password" name="password" id="reg-password" required placeholder="Password"
                                class="w-full pl-12 pr-12 py-4 rounded-full border border-gray-300 text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-[#A5D836] focus:border-transparent transition-all placeholder-gray-400 shadow-sm font-medium">
                            <div class="absolute inset-y-0 right-0 pr-5 flex items-center cursor-pointer"
                                onclick="togglePassword('reg-password', 'eye-icon-reg')">
                                <svg id="eye-icon-reg" class="h-5 w-5 text-gray-400 hover:text-gray-600" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-[#209E43] to-[#023A4B] hover:from-[#1a7f36] hover:to-[#012935] text-white font-bold text-lg py-4 rounded-full shadow-[0_10px_20px_rgba(2,58,75,0.25)] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_15px_25px_rgba(2,58,75,0.35)] mt-4">
                            Register
                        </button>
                    </form>
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-gray-500 font-medium text-sm">
                            Sudah punya akun?
                            <button onclick="switchLayout('login')"
                                class="text-[#209E43] font-bold hover:underline hover:text-[#1a7f36]">
                                Log in
                            </button>
                        </p>
    ...
    <script>
        // Fungsi untuk mengubah visibilitas password (bisa dipakai di login & register)
        ...
        // Fungsi untuk Switch Layout Login <-> Register
