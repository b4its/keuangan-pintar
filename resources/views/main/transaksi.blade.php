...
@section('title', 'Transaksi - Keuangan Pintar')

@section('content')

    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
            <h1 class="text-3xl font-[800] tracking-tight text-[#003344]">Transaksi</h1>
        ...
        @for ($i = 1; $i <= 8; $i++)
            ...
            <div
                ...
                <div class="flex-1 flex items-center gap-4 mb-2 md:mb-0">
                    ...
                    <div>
                        <h3 class="font-bold text-lg text-[#003344] group-hover:text-[#209E43] transition-colors">Nama Barang
                            Item {{ $i }}</h3>
                        <p class="text-xs text-gray-400">ID: TRX-2025-00{{ $i }}</p>
                    </div>
                </div>
                ...
                <div class="w-full md:w-32 flex md:justify-center mb-2 md:mb-0">
                    <span class="font-bold text-gray-600 group-hover:text-[#003344]">5 Pcs</span>
                </div>

                <div class="w-full md:w-48 text-left md:text-right">
                    <span class="block text-xl font-[800] text-[#003344]">
